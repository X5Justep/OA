...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:369px;top:9px;">
    <div component="$UI/system/components/justep/data/bizData" xid="dSignature"
      concept="OA_SL_Signature" autoNew="false" autoLoad="true">
  ...
  <div xid="view"> 
   ...
   <label class="control-label" xid="controlLabel11"><![CDATA[应用时间]]></label></div>
  <div class="col-sm-4" xid="col22">
   ...
   <label class="control-label" xid="controlLabel14">用印文件及事由</label></div>
  <div class="col-sm-10" xid="col27">
   <textarea component="$UI/system/components/justep/textarea/textarea" class="form-control" xid="textarea5" bind-ref="dSignature.ref('fSake')"></textarea></div></div><div class="form-group" xid="formGroup1">
