...
public class Fn {
	...
	private static final String CONCEPT = "OA_AM_DistoryApplyM";
	private static final String CONCEPT_D = "OA_AM_DistoryApplyD";
	...
	public static String getSummary(String bizID) {
		...
		String s = String.format("%s在%s申请销毁%s等档案。", 
					row.getString("fCreatePsnName"), 
					new SimpleDateFormat("yyyy-MM-dd").format(row.getDate("fDistoryDate")),
					detail);
		return s;
	}
}