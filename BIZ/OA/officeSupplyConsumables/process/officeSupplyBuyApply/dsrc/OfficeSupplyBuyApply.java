...
public class OfficeSupplyBuyApply {
	public static void officeSupplyBuyApplyProcessAfterFinish() {
		String sql = null;
		String bizID = ProcessUtils.getProcessData1();
		sql = "select d.fItemID,d.fFactNum from OA_OSC_BuyApplyD d where d.fMasterID = '" + bizID + "'";
