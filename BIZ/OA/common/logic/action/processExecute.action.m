...
<model xmlns="http://www.justep.com/model">  
  <procedure name="getCurrentExecuteDataProcedure" code-model="/OA/common/logic/code"
    code="com.justep.oa.ProcessExecute.getCurrentExecuteData"> 
  ...
  <action name="getCurrentExecuteDataAction" procedure="getCurrentExecuteDataProcedure"
    global="true"> 
  ...
  <procedure name="setCurrentExecuteDataProcedure" code-model="/OA/common/logic/code"
    code="com.justep.oa.ProcessExecute.setCurrentExecuteData"> 
    <parameter name="dataModel" type="String"/>  
    <parameter name="executeConcept" type="String"/>  
    <parameter name="bizID" type="String"/>  
    <parameter name="taskID" type="String"/>  
  ...
  <action name="setCurrentExecuteDataAction" procedure="setCurrentExecuteDataProcedure"
    global="true"> 
    <public name="dataModel" type="String"/>  
    <public name="executeConcept" type="String"/>  
    <public name="bizID" type="String"/>  
  ...
  <procedure name="getExecuteListDataProcedure" code-model="/OA/common/logic/code"
    code="com.justep.oa.ProcessExecute.getExecuteListData"> 
    <parameter name="dataModel" type="String"/>  
    <parameter name="executeConcept" type="String"/>  
    <parameter name="bizID" type="String"/>  
  ...
  <action name="getExecuteListDataAction" procedure="getExecuteListDataProcedure"
    global="true"> 
    <public name="dataModel" type="String"/>  
    <public name="executeConcept" type="String"/>  
    <public name="bizID" type="String"/>  
