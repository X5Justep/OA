...
public class Fn {
	...
	private static final String CONCEPT = "OA_WM_LeaveApply";
	...
	public static String getSummary(String bizID) {
		...
		String s = String.format("%s申请%s%s天%s小时,请假时间范围为:%s -- %s。", 
					row.getString("fApplyPersonName"), row.getString("fLeaveTypeName"), 
					row.getInt("fLeaveDays"), row.getFloat("fLeaveHours"),
